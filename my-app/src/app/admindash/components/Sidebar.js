...
import { ClipboardList, CalendarCheck, LayoutDashboard, Menu, X, LogOut } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/admindash/overview', icon: <LayoutDashboard size={20} /> },
    { name: 'Employees', path: '/admindash/employeemanagement', icon: <ClipboardList size={20} /> },
    { name: 'Tasks', path: '/admindash/tasks', icon: <ClipboardList size={20} /> },
    { name: 'Leaves', path: '/admindash/leave', icon: <CalendarCheck size={20} /> },
  ];
