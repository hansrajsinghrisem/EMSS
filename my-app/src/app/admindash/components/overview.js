      ...
      const fetchCounts = async () => {
        try {
          const [
            ...
            axios.get('https://emss-wtii.onrender.com/api/approved-users'),
            axios.get('https://emss-wtii.onrender.com/api/denied-users'),
            axios.get('https://emss-wtii.onrender.com/api/pending-users'),
            axios.get('https://emss-wtii.onrender.com/api/deleted-users'),
            axios.get('https://emss-wtii.onrender.com/api/leaves/pending'),
            axios.get('https://emss-wtii.onrender.com/api/leaves/approved'),
            axios.get('https://emss-wtii.onrender.com/api/leaves/denied'),
            axios.get('https://emss-wtii.onrender.com/api/tasks'),
            axios.get('https://emss-wtii.onrender.com/api/tasks/completed'),
            axios.get('https://emss-wtii.onrender.com/api/tasks/deleted'),
          ]);
          setCounts({
