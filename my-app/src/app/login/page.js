        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              whileHover={{ boxShadow: '0 0 15px rgba(236, 72, 153, 0.5)' }}
            >
              {loading ? (
            ...
            >
              <motion.button
                ...
                whileHover={{ boxShadow: '0 0 10px rgba(236, 72, 153, 0.3)' }}
              >
                GitHub
              </motion.button>
              <motion.button
    ...
    <div className="min-h-screen relative bg-gradient-to-br from-pink-50 to-blue-100 animate-gradient">
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          <Link
            href="/"
            className="text-3xl font-extrabold bg-gradient-to-r from-pink-600 to-blue-500 bg-clip-text text-transparent"
          >
            Auspicioussoft
          </Link>
